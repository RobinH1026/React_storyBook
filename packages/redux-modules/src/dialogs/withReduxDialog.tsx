...
export interface ReduxDialogStateProps {
  isOpen: boolean;
}

export type WithReduxDialogProps = ReduxDialogStateProps &
  DispatchProps &
  OwnProps;
...
const withReduxDialog =
  ...
  <T, OriginalProps>(WrappedComponent: ComponentType<any | string>) => {
     ...
     */
    const mapStateToProps = (state: unknown): ReduxDialogStateProps => ({
